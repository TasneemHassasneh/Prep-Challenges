...
const objLat = (obj) => {
    let p =`my name is ${obj.firstName[0].toUpperCase()+obj.firstName.slice(1)} ${obj.lastName[0].toUpperCase()+obj.lastName.slice(1)} I am ${obj.age} YO, and I love ${obj.hobby}.`;
    return p;
};
// -------------------------------------------------------------------------------------------------------
